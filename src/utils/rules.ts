...
export const schema = yup.object({
  ...
  // Thêm .default('') vào các trường price_min và price_max trong schema. Điều này đảm bảo rằng chúng sẽ luôn có giá trị mặc định là chuỗi rỗng ('') thay vì undefined
